...
@interface MariketingTableViewController ()
@end

@implementation MariketingTableViewController
...
-(void)checkTheBusi{
    ...
    [MariketingTableViewController showAlertWithTitle:@"业务描述" AndMessages:busiDesc];
}
